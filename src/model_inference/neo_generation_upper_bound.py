...
def generate_answers():
    ...
    for question, answer_paragraph in tqdm(zip(dev_set['question'], dev_set['text']), desc='Answering questions'):
        ...
        prompt = f"Relevante paragraffer: {answer_paragraph} Spørgsmål: {question} Indsæt svar her baseret på de relevante paragraffer:"
...
if __name__ == "__main__":
    ...
    with open(f'../../output/inference/neo_gen_upper_bound.txt', 'w') as file:
        for answer in answers:
            file.write(answer + '\n')

    print(f"Answers saved to output/inference/neo_gen_upper_bound.txt")