...
commands=(
  ...
  "python neo_generation_baseline.py"
  "python neo_generation_random_context.py"
  "python neo_generation_upper_bound.py"
  "python t5_generation_baseline.py"
  "python t5_generation_random_context.py"
  "python t5_generation_upper_bound.py"
)
